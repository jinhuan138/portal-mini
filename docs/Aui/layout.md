...
```html
<aui-row :gutter="10">
  <aui-col :xs="8" :sm="6" :md="4" :lg="3"><div class="grid-content bg-purple"></div></aui-col>
  <aui-col :xs="4" :sm="6" :md="8" :lg="9"><div class="grid-content bg-purple-light"></div></aui-col>
  <aui-col :xs="4" :sm="6" :md="8" :lg="9"><div class="grid-content bg-purple"></div></aui-col>
  <aui-col :xs="8" :sm="6" :md="4" :lg="3"><div class="grid-content bg-purple-light"></div></aui-col>
</aui-row>
