...
:::demo
```html
<aui-tree :data="data" :props="defaultProps" @node-click="handleNodeClick"></aui-tree>
...
<div class="buttons">
  <aui-button @click="getCheckedNodes">通过 node 获取</aui-button>
  <aui-button @click="getCheckedKeys">通过 key 获取</aui-button>
  <aui-button @click="setCheckedNodes">通过 node 设置</aui-button>
  <aui-button @click="setCheckedKeys">通过 key 设置</aui-button>
  <aui-button @click="resetChecked">清空</aui-button>
</div>
      ...
      renderContent(h, { node, data, store }) {
        return (
          <span class="custom-tree-node">
            <span>{node.label}</span>
            <span>
              <aui-button size="mini" type="text" on-click={ () => this.append(data) }>Append</aui-button>
              <aui-button size="mini" type="text" on-click={ () => this.remove(node, data) }>Delete</aui-button>
            </span>
          </span>);
      }
    }
...
:::demo
```html
<aui-tree :data="data" :props="defaultProps"
    @node-click="handleNodeClick"
    :draggable="true"
  ...
  export default {
    ...
    methods: {
      ...
      handleDragStart(node, e) {
        console.log("handleDragStart", node, e);
      },
      handleDragEnter(node, e) {
        console.log("handleDragEnter", node, e);
      },
      handleDragLeave(node, e) {
        console.log("handleDragLeave", node, e);
      },
      handleDragOver(node, e) {
        console.log("handleDragOver", node, e);
      },
      handleDragEnd(node, e) {
        console.log("handleDragEnd", node, e);
      },
      handleDrop(node, e) {
        console.log("handleDrop", node, e);
      },
      ...
      allowDrag(draggingNode) {
        return draggingNode.data.label.indexOf('三级 3-2-1') === -1;
      }
    }
  };
</script>
