...
- `$aui.msgbox.show(options)`
- `$aui.alert.show(content, title, options)` 或 `$aui.alert.show(content, options)`
- `$aui.confirm.show(content, title, options)` 或 `$aui.confirm.show(content, options)`
- `$aui.prompt.show(content, title, options)` 或 `$aui.prompt.show(content, options)`
